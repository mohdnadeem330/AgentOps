    ...
    export default class UpdateCloneCase extends NavigationMixin(LightningElement)  {
        ...
        loaddata(datavalue)
        {
            ...
            if (this.selectedOption == 'Queries') {
                ...
                this.isFcrDisabled = true;
                this.isFCR = false;
            } else if (this.selectedOption == 'Requests') {
         ...
         //   this.accountRelatedFielsDisabled =true;
            ...
            console.log('datavalue.fields.Status.value'+datavalue.fields.Status.value);
            // if(datavalue.fields.Status.value =='New' || datavalue.fields.Status.value =='Work In Progress')
            //     {
            //         console.log('Commingnew');
        ...
        @wire(getPicklistValuesByRecordType, {
            ...
            wiredRecordTypeInfo({data, error}) {
                if(data) {
                    ...
                    console.log('This data.picklistFieldValues.SubCategory__c'+data.picklistFieldValues.SubCategory__c);
                    if(this.isRecordTypeChanged == false)
                    {
                    ...
                    console.log('this.pickCaseCategory'+JSON.stringify(this.pickCaseCategory));
        ...
        handleRadioChange(event) {
            ...
            console.log('In record Type');
            this.isRecordTypeChanged =false;
        ...
        handlefields(updateflag,parentCaseId)
            ...
            console.log('this.isVisitorCase'+this.isVisitorCase);
            if(this.isVisitorCase == true)
            {console.log('this.isVisitorCase1'+this.isVisitorCase);
          ...
          //  fields[CaseOrigin.fieldApiName] = this.CaseOriginValue;
            ...
            if(this.selectedOption == 'Requests' || this.selectedOption == 'Complaints'){
               
            }
            else
            {
                this.showToast('Error', 'Please select CaseType', 'error');
                return;
            }
            ...
            if(fields[UNIT.fieldApiName] == null && this.isVisitorCase == false){
        ...
        handleUpdate(parentCaseId) {
            ...
            updateRecord(recordInput)
                .then(result => {
                    console.log('Case Update screen'+result.id);
                    this.isLoading = false;
                    this.showToast('Success', 'Case Converted successfully!', 'success');
                    console.log('Navigation Start');
                    this.CloseUpdateScreen();
              
            console.log('Navigation End1');
                })
                .catch(error => {
