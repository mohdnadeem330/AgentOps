...
import getLookupValues from "@salesforce/apex/ECSS_CustomAdvanceLookupCmpController.getLookupValuesContact";
...
export default class CustomLookupCmp extends LightningElement {
  ...
  @api labelForComponent = "All Existing Contacts";
  @api placeHolder = "Search Contact";
  @api recordLimit = 5;
  ...
  set selectedRecord(value) {
    if (value && value.Id) {
      ...
      this.selectedRecordLabel = value.Name;
      this.selectedRecordString = JSON.stringify(value);
