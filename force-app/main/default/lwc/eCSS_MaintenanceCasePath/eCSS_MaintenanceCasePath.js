...
export default class eCSS_MaintenaceCasePath extends LightningElement {
  @api recordId;
  ...
  get picklistValues() {
    ...
    if (this.record.data) {
      ...
      if (this.fieldType == "Status") {
        ...
        if (
          !this.selectedValue &&
          this.record.data.fields.Sub_Status__c.value
        ) {
      ...
      if (
        ...
        this.picklistFieldValues.data.values
      ) {
        let selectedUpTo = 0;
        for (let item in this.picklistFieldValues.data.values) {
          if (
            ...
            let classList;
            if (
              this.picklistFieldValues.data.values[item].value ===
                this.selectedValue &&
