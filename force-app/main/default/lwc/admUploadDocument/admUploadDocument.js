...
import uploadDocument from '@salesforce/apex/ADMUploadDocumentController.uploadDocument';
import uploadDocumentCheck from '@salesforce/apex/ADMUploadDocumentController.uploadDocumentCheck';
import { updateRecord } from 'lightning/uiRecordApi';
export default class AdmUploadDocument extends LightningElement {
    ...
    handleUploadDocument() {
        ...
        uploadDocument({ srId: this.recordId }).then(result => {

            console.log('uploadDocument:');
            console.log(result);
            if (result == '') {

                uploadDocumentCheck({ srId: this.recordId }).then(result => {
