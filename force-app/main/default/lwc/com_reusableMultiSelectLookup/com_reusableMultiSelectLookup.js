...
import retriveSearchData from '@salesforce/apex/Com_ReusableMultiSelectLookupCtrl.retriveSearchData';

export default class Com_reusableMultiSelectLookup extends LightningElement {
    @api objectname = '';
