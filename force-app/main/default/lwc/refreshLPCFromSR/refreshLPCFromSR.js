...
import getOutstandingLPCforSalesOrder from '@salesforce/apex/RefreshLPCFromSRController.getOutstandingLPCforSalesOrder';
import { updateRecord } from 'lightning/uiRecordApi';
export default class RefreshLPCFromSR extends NavigationMixin(LightningElement) {
    ...
    handleRefresh() {
        ...
        getOutstandingLPCforSalesOrder({ srId: this.recordId }).then(result => {

            console.log('getOutstandingLPCforSalesOrder:');
            console.log(result);
            if (result == '') {
                this.showToast('Success', 'LPC Information Updated Successfully', 'success');
                this.updateRecordView(this.recordId);
            } else {
                this.showToast('Error', result, 'error');
                this.errorMessageToDisplay = result;
                this.isLoaded = false;
            }
