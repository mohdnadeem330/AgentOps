...
import generateInvoiceDocument from '@salesforce/apex/QuarterlyBrokerCommissionController.generateInvoiceDocument';

export default class regenerateQBCInvoice extends LightningElement {
    @api recordId;
    isLoading=true;
    recordLoaded=false;
