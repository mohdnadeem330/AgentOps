...
import getCommissionTrail from '@salesforce/apex/CommissionsReportController.getCommissionTrail';
import updateStatus from '@salesforce/apex/CommissionsReportController.updateStatus';
import { NavigationMixin } from 'lightning/navigation';

export default class ManageInvoicesModal extends NavigationMixin(LightningElement) {
    @api commissionRecordId;
    @api enableAction;
    brokerInvoiceURL;
    urlPrefix ='/BrokerInvoicePDF?invoiceId=';
