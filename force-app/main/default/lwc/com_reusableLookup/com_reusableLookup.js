...
import fetchRecords from '@salesforce/apex/Com_ReusableMultiSelectLookupCtrl.fetchLookupRecords';
/** The delay used when debouncing event handlers before invoking Apex. */
const DELAY = 500;

export default class Com_reusableLookup extends LightningElement {
    @api helpText = "";
    @api label = "";
    @api required;
